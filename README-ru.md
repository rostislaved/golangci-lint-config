...
---
Эта конфигурация в настоящее время соответствует версии golangci-lint v2.12.2

Она также должна работать с более новыми версиями golangci-lint, однако в новых релизах могут появляться дополнительные настройки, которые пока не включены в данной конфигурации.
...
---
#### P.S.
К сожалению в репозитории `golangci-lint` нет примера конфига со всеми дефолтными настройками и предлагается самостоятельно следить за changlog'ом, чтобы не пропустить новые правила и настройки